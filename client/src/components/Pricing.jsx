...
const Pricing = () => {
    return <div className=" mx-auto">
        <div className="container-fluid BestPlan" id="container-fluid ">
            <h1 className="Choosetext" data-aos="zoom-in" data-aos-duration="1500" id="ctbp" style={m}>Choose the Best Plan </h1>

            <div className="container pt-5 ">
                <div className=" gx-0  flex items-center block3 standItem" data-aos="fade-up" data-aos-duration="1500" id="items">
